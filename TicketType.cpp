//Filename: TicketType.cpp
#include <iostream>
#include <conio.h>
#include <fstream>
#include <sstream>
#include <direct.h>
#ifndef TICKET_TYPE_CPP
#define TICKET_TYPE_CPP
using namespace std;
...
class TicketType{
	...
	public:
		//constructor for class TicketType
		TicketType(){
			FILE = "database";
			VIEW_FILE = "record";
			MEDIC_FILE = "ticket";
		...
		//constructor with parameter for class TicketType
		TicketType(int argc, char *argv[]){
		...
		//destructor for class TicketType
		~TicketType(){};
		 
		//method to add ticket type
		void addType(){
			system("cls");
			string type;
		...
		int displayType(string type){
			...
			if(openfr(1, "type_list.txt")=="0"){
				...
				if(type=="add"){
					cout << endl << endl << endl << " \t\t99 >> To add new ticket type" << endl << endl;
					cout << " \t\t0 >> Go Back" << endl;
				...
				cout << endl << endl << " \t\t99 >> To add new ticket type" << endl << endl;
				cout << " \t\t0 >> Go Back" << endl;
				cout << endl << " \t" << " Choose a Movie type to "<< type << " : ";
		...
		//method to get the selected ticket type
		...
		string deleteType(){
			...
			if(oldf=="0"){
				...
				if(del!="empty"){
					cout << endl << " All the ticket record for this type will be clear!!!" << endl;

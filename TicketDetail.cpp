...
//class about ticket detail
class TicketDetail{
	private:
		string _id; 			//variable for ticket id
		string _title; 			//variable for ticket title
		string _type; 			//variable for ticket type
		string _describe[3];	//variable for ticket description
		double _purchasePrice;	//variable for ticket purchase price
		double _soldOutPrice;	//variable for ticket sold out price
		int _quantity; 			//variable for ticket quantity
	...
	public:
		//constructor for class TicketDetail
		TicketDetail(){
			test=0;
		};
		
		//destructor for class TicketDetail
		~TicketDetail(){};
		
		//method to display ticket detail
		void displayTicket(int type){
			
			cout << endl << " ID\t\t\t: " << _id << endl;
			cout << " Title\t\t\t: " << _title << endl;
			cout << " Type\t\t\t: " << _type << endl;
			cout << " Langauge\t\t: " << _describe[0] << endl;
		...
		//method to display ticket type
		void printTicketType(){
			cout << endl << " Ticket type : " << _type << endl;
		};
		
		//method to ask user input for ticket id and check input
		...
		//method to ask user input for ticket title and check input
		...
		//method to ask user input for ticket description and check input
